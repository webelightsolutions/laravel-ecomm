...
<head>
  ...
  <title>Kalaxpress|Admin Panel</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Kala</b>xpress Admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form role="form" method="POST" action="{{ url('/admin/password/reset') }}">
      ...
      <div class="form-group has-feedback{{ $errors->has('email') ? ' has-error' : '' }}">
        <input type="email" class="form-control" placeholder="Email-ID" value="{{ old('email') }}" name="email">
